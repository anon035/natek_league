...
const SingleMatch = () => {
  ...
  return (
    <div className="ui segment toggleView" onClick={() => {
      const element = document.querySelector('.toggleView');
      if(element.style.maxHeight !== '100%'){
        ...
        <div className="ui segment">
          ...
          <div className="versus ui vertical divider"> 0 : 2 </div>
        </div>
        <div className="ui segment">
          <div className="ui two column very relaxed grid">
            <div className="column">
        ...
        <div className="ui segment">
          ...
          <div className="versus ui vertical divider"> 2 : 0 </div>
        </div>
        <div className="ui segment">
          <div className="ui two column very relaxed grid">
            <div className="column">
